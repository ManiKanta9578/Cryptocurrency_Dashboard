...
//PrimaryChart component have Line,bar charts , dropdown menus and buttons has sort by date & time
...
export const PrimaryChart = () => {
  ...
  //These function contains sorting by date & time 
  ...
  return (
    <div className="container-fluid w-full h-96 border border-gray-100 bg-white  backdrop-blur-md my-5 rounded-lg shadow-sm px-4 pt-3 lg:mt-3">
      
      <div className="text-black flex py-0 pt-20 ml-4 absolute text-md font-semibold font-sans">
 ...
 {/* buttons for sorting */}
        ...
        <button
          ...
          className={`px-3 py-1.5 ${
            days === 1 ? " border-blue-400 text-blue-700 border text-blue bg-blue-100" : ""
        ...
        <button
          ...
          onClick={oneWeek}
          className={`px-3 py-1.5 ${
            days === 7 ? " border-blue-400 text-blue-700 border text-blue bg-blue-100" : ""
          } rounded-md text-xs text-black bg-gray-200  backdrop-blur-md font-semibold lg:mt-2`}
        >
          1W
        </button>
        ...
        <button
          ...
          onClick={oneMonth}
          className={`px-3 py-1.5 ${
            days === 30 ? " border-blue-400 text-blue-700 border text-blue bg-blue-100" : ""
          } rounded-md text-xs text-black bg-gray-200  backdrop-blur-md font-semibold lg:mt-2`}
        >
          1M
        </button>
       ...
       {/* 180 days */}
        <button
          ...
          onClick={sixMonths}
          className={`px-3 py-1.5 ${
            days === 180 ? " border-blue-400 text-blue-700 border text-blue bg-blue-100" : ""
          } rounded-md text-xs text-black bg-gray-200  backdrop-blur-md font-semibold lg:mt-2`}
          >
          6M
        </button>
        ...
        <button
          ...
          onClick={oneYear}
          className={`px-3 py-1.5 ${
            days === 365 ? " border-blue-400 text-blue-700 border text-blue bg-blue-100" : ""
          } rounded-md text-xs text-black bg-gray-200  backdrop-blur-md font-semibold lg:mt-2`}
        >
          1Y
        </button>

        {/* Dropdown menu for cryptocurrencies */}

        <div className="flex absolute items-center rounded-md bg-gray-200 text-black  backdrop-blur-md p-2 w-24 lg:left-[16rem] lg:mt-4 md:left-[25rem] md:mt-4 sm:right-[9rem] mt-20 ml-2">
          <select
            onChange={(e) => {
          ...
          {/* dropdownmenu for types of charts */}

          <div className="rounded-md bg-gray-200  backdrop-blur-md text-black p-2 absolute lg:left-[6rem] md:left-[6rem] left-[6rem] w-28 ml-5">
            <select
            ...
            >
              ...
              <option className="text-black" value={`BarChart`}>Verticle Bar Chart</option>
              <option className="text-black" value={`BarChartH`}>Horizontal Bar Chart </option>
